...
# Based on https://github.com/rickh94/airtable_local_backup
...
class DownloadTable(object):
    ...
    """
    def __init__(self, base_key, table_name, api_key=None, compression=True, fields=dict(), discard_attach=False):
